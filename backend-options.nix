  ...
  backendOptions = {
    ...
    settings = mkOption {
      ...
      default = {
        ...
        #   AllowTrepass=true  -> non-members can enter others' safehouses.
    ...
    workshopItems = mkOption {
      ...
      default = [
        ...
        # 2026-08-18 but removed 2026-08-19 — it did not work on the live
    ...
    mods = mkOption {
      ...
      default = [
        ...
        "SolarFloodlight"
        "RealisticCookingTimes"
        "VHSSkillNameInTooltip"
        "Neat_Rocco"
        "ComputerModkum"
        "SeedSeasonIndicator"
        "NewMusic"
